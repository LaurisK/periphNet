...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, gpio_flashCs_Pin, GPIO_PIN_SET);  /* CS must be HIGH (inactive) */
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6
                          |GPIO_PIN_7|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_0
                          |GPIO_PIN_1;
  ...
  /*Configure GPIO pin : PA6 (LED for bootloader/app communication test) */
  ...
  /*Configure GPIO pins : gpio_button1_Pin gpio_button2_Pin gpio_button3_Pin */
  GPIO_InitStruct.Pin = gpio_button1_Pin|gpio_button2_Pin|gpio_button3_Pin;
  ...
  /*Configure GPIO pin : gpio_rs485de_Pin */
  GPIO_InitStruct.Pin = gpio_rs485de_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(gpio_rs485de_GPIO_Port, &GPIO_InitStruct);
